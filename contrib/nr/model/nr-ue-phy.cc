...
NrUePhy::NrUePhy()
{
    ...
    Simulator::Schedule(m_ueMeasurementsFilterPeriod, &NrUePhy::ReportUeSlRsrpMeasurements, this);
}
...
NrUePhy::PhyPsschPduReceived(const Ptr<PacketBurst>& pb, const SpectrumValue& psd)
{
    ...
    for (auto& pktIt : dataPkts)
    {
        ...
        //if ((tag.GetLcid() == 4))
        {
            ...
            {
                NS_LOG_UNCOND(this << "First RSRP measurement entry");
            ...
            {
                NS_LOG_UNCOND(this << "RSRP Measurement entry found... Adding values");
...
NrUePhy::ReportUeSlRsrpMeasurements()
{
    ...
    if (m_ueSlRsrpMeasurementsEnabled)
    {
             ...
             it++)
        {
            ...
            NS_LOG_UNCOND(this << " UE L2 Id " << it->first << " averaged RSRP (dBm) " << avgRsrpDbm
